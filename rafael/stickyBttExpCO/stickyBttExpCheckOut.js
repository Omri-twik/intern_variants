...
function mainJS() {
  ...
  customStickyDiv.style.backgroundColor = targetBackground.getPropertyValue(
    "background-color"
  );
  ...
  ///
  let undisplayableCharacter = getComputedStyle(
    originalIcon,
    "::before"
  ...
  // #################################################################
  // message from Denis:
  // what you did below is you cloned an element, so your variable carries the cloned element and not the clone's selector (string)
  // you might want to assign a unique class or id to the clone to use that as the selector
  // #################################################################
