...
<style>
    ...
    #twik-sidebar-cart {
        ...
        display: grid;
        grid-template-rows: 70px 60px 1fr 110px;
        /* grid-gap: 10px; */
    }
    ...
    .twik-cart-product-list-wrapper {
        overflow-y: auto;
        overflow-x: none;
    }

    .twik-cart-checkout-btn-wrapper {
        margin-top: 30px;
        margin-bottom: 30px;
        display: flex;
        justify-content: center;
    ...
    .twik-cart-product-quantity-container {
        width: 100%;
    }

    .twik-cart-product-quantity-wrapper {
        position: relative;
        width: 100%;
    }
    ...
    .twik-cart-details-subheader,
    .twik-cart-price,
    .twik-remove-item {
        font-size: 13px;
    }

    .twik-cart-checkout-btn-a,
    .twik-cart-checkout-btn-a:hover,
    .twik-cart-checkout-btn-a:focus,
    .twik-cart-checkout-btn-a:active {
...
<div id="twik-sidebar-cart-wrapper">
    ...
    <div id="twik-sidebar-cart">
        ...
        <div class="twik-cart-row twik-cart-shipping-wrapper">
            <div class="twik-cart-shipping">
                Shipping
            </div>
        </div>
        <div class="twik-cart-row twik-cart-product-list-wrapper">
            ...
            <div class="twik-cart-empty">Your cart is empty</div>
        </div>
            ...
            <div class="twik-cart-checkout-btn-wrapper">
                <a href="/checkout" role="button" class="twik-cart-checkout-btn-a">
                    <div class="twik-cart-checkout-btn">
                        <span class="twik-cart-checkout-text">CHECKOUT</span>
                        <span style="font-size: 0.25em;">&#9725</span>
...
function mainJS() {
  originalCartButton = document.querySelector(`a[href="/cart"]`);

  document.head.insertAdjacentHTML("beforeend", cartSTYLE);
  document.body.insertAdjacentHTML("beforeend", cartHTML);

  sidebarCart = document.querySelector("#twik-sidebar-cart");
  overlay = document.querySelector("#twik-overlay");
  productList = document.querySelector(".twik-cart-product-list");
  cartEmptyDiv = document.querySelector(".twik-cart-empty");
  ...
  getCart = () => {
    return JSON.parse(getRequest("/cart.json"));
  };
  ...
  replaceCartButton = () => {
    let cloneCartButton = originalCartButton.cloneNode(true);
    cloneCartButton.setAttribute("data-action", "");
    cloneCartButton.setAttribute("onclick", "");
    cloneCartButton.addEventListener("click", (e) => {
      e.preventDefault();
      refreshCart();
      openOverlay();
      openCart();
  ...
  document
    .querySelector("#twik-sidebar-cart-wrapper")
  ...
  document.querySelector(".twik-cart-close").addEventListener("click", () => {
    closeCart();
    closeOverlay();
  });
