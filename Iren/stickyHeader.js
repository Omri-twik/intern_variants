(function() {
    setTimeout(function() {
        var element ;
        if(document.querySelector('#shopify-section-header')!=undefined &&
            document.querySelector('#shopify-section-header').clientHeight<200){
            element = document.querySelector('#shopify-section-header');
        } else if(document.querySelector('.header')!=undefined){
            element = document.querySelector('.header');
        }else if(document.querySelector('.nav-bar')!=undefined){
            element = document.querySelector('.nav-bar');
        } else if(document.querySelector('header')!=undefined) {
            element = document.querySelector('header');
        }

        element.classList.add('data-sticky');
        element.style.zIndex = '9999';
        var sticky = new Sticky(".data-sticky", {wrap: true});
    }, 1000);
})();
